...
<template>
    <a @click="$emit('roomChanged', conversation)" class="cursor-pointer hover:opacity-80">
        <div
            class="justify-start p-1 transition ease-in-out delay-25 mx-2 align-baseline flex my-1 bg-gray-400 hover:scale-105 hover:bg-gray-400 duration-30 rounded-md">
            <div >
